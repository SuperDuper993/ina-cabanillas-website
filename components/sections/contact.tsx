        ...
        >
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2 mt-2">
              <p className="text-base font-semibold tracking-widest uppercase text-brand-indigo">Hva skjer videre?</p>
              <ol className="flex flex-col gap-1.5">
                {[
                  ...
                  <li key={i} className="flex items-center gap-3 text-brand-muted text-base">
          ...
          <div>
            {status === 'success' ? (
              <div className="flex flex-col items-center justify-center h-full gap-4 text-center bg-brand-lavender rounded-2xl p-10">
                ...
                <button onClick={() => setStatus('idle')} className="text-brand-indigo text-base mt-4 hover:underline">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5 bg-brand-lavender rounded-2xl p-8">
                ...
                <div>
                  <label className="block text-foreground text-base font-medium mb-2" htmlFor="organisasjon">
                    Organisasjon <span className="text-brand-muted text-base font-normal">(valgfritt)</span>
                  </label>
                  <input
                    id="organisasjon"
                    name="organisasjon"
                ...
                <div>
                  <label className="block text-foreground text-base font-medium mb-2" htmlFor="anledning">
                    Anledning <span className="text-brand-muted text-base font-normal">(valgfritt)</span>
                  </label>
