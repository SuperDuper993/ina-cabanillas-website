...
export function SocialIcons() {
  ...
  return (
    <div className="relative flex items-center gap-0.5 px-1.5 py-1.5 rounded-2xl bg-brand-dark border border-white/[0.08]">
      ...
      {socials.map((social, index) => (
        ...
        >
          ...
          <span
            className={`absolute -top-10 left-1/2 -translate-x-1/2 px-2.5 py-1 rounded-lg bg-white text-brand-dark text-[11px] font-medium whitespace-nowrap transition-all duration-300 ease-out ${
